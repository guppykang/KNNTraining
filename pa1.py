...
newTrainingSet = project(trainingSet, projectionSet)

newTestSet = project(testSet, projectionSet)

newValidationSet = project(validationSet, projectionSet)
...
validationProjected = []
oneValidationProjected = runKnn(1, newValidationSet, newTrainingSet, validationSetLabel, trainingSetLabel)
threeValidationProjected = runKnn(3, newValidationSet, newTrainingSet, validationSetLabel, trainingSetLabel)
fiveValidationProjected = runKnn(5, newValidationSet, newTrainingSet, validationSetLabel, trainingSetLabel)
nineValidationProjected = runKnn(9, newValidationSet, newTrainingSet, validationSetLabel, trainingSetLabel)
fifteenValidationProjected = runKnn(15, newValidationSet, newTrainingSet, validationSetLabel, trainingSetLabel)
print(datetime.datetime.now().time())
...
testErrorProjected = runKnn(projectedMin[1], newTestSet, newTrainingSet, testSetLabel, trainingSetLabel)